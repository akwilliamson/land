...
with open('deschutes.csv', 'w') as csvfile:
    deschutes_writer = csv.writer(csvfile, delimiter=',')

    with open('taxlots.csv', 'r') as taxlots_csv:
        ...
        for taxlot_number in taxlot_numbers:
            ...
            url = 'http://dial.deschutes.org/results/general?value=' + taxlot_number_string
